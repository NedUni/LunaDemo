//
//  PhoneAuthNextButton.swift
//  Luna
//
//  Created by Will Polich on 26/4/2022.
//
...
struct PhoneAuthNextButton: View {
    ...
    var body: some View {
        Button {
            if isTriggered {
                ...
                print(adjustedPhone)
                sessionService.phoneSignInVerification(phoneNumber: String(adjustedPhone), new: true) { verificationID, error in
