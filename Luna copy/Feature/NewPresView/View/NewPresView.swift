...
////  Luna
////
////  Created by Will Polich on 6/2/2022.
////
//
//import SwiftUI
//import SDWebImageSwiftUI
//
//struct NewPresView: View {
//    @StateObject var vm = EventHandler()
//    @EnvironmentObject var sessionService: SessionServiceImpl
//    @EnvironmentObject var homeVM : ViewModel
//    @Binding var showNewPres: Bool
...
//                            } else {
//                                if linkedEvent != nil {
//                                    vm.createPres(uid: sessionService.userDetails.uid, name: name, description: description, date: date, time: startTime, address: address, linkedEvent: sessionService.getEventID(event: linkedEvent!), linkedVenue: "", token: sessionService.token)
//                                } else if linkedVenue != nil {
//                                    vm.createPres(uid: sessionService.userDetails.uid, name: name, description: description, date: date, time: startTime, address: address, linkedEvent: "", linkedVenue: sessionService.getVenueID(venue: linkedVenue!), token: sessionService.token )
//                                } else {
//                                    vm.createPres(uid: sessionService.userDetails.uid, name: name, description: description, date: date, time: startTime, address: address, linkedEvent: "", linkedVenue: "", token: sessionService.token)
//                                }
//                                
//                                Task {
...
//                })
//            .navigationBarTitle("Create New Pres", displayMode: .inline)
//        }
...
//}
//
//struct NewPresView_Previews: PreviewProvider {
//    @State static var showNewEvent = true
//    
//    static var previews: some View {
//        NewPresView(showNewPres: $showNewEvent)
//    }
//}
